...
ENTITY_DEFS: Dict[str, Dict[str, Any]] = {
    ...
    "boss": {
        ...
        "animations": {
            ...
            "idle-left": {"frames": [13], "texture": "boss-walk"},
            "idle-right": {"frames": [5], "texture": "boss-walk"},
            "idle-down": {"frames": [1], "texture": "boss-walk"},
            "idle-up": {"frames": [9], "texture": "boss-walk"},
            "attack-left": {
                "frames": [13, 14, 15, 16],
                "interval": 0.1,
                "loops": 1,
